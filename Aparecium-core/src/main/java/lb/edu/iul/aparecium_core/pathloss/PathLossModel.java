...
public interface PathLossModel {
    ...
    double estimatePathLoss(Location receiver, AccessPoint accessPoint, List<Wall> walls);
    double estimateDistance(double requiredSignalPower, double pathLoss1m, double transmissionPower, List<Wall> walls);
}
